...
| [COST-7687](https://redhat.atlassian.net/browse/COST-7687) | Implement workers and scheduled jobs | ✅ | Celery Beat + 10 workers ✅, ROS/Kruize when `ros.enabled` ✅, SaaS queues (`hcs`, `subs_*`) default `replicas: 0` ✅ ([#73](https://github.com/project-koku/koku-service-operator/pull/73)). Profile sizing → [COST-8095](https://redhat.atlassian.net/browse/COST-8095). |

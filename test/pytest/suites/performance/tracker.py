...
class PerfCleanupTracker:
    ...
    def __init__(self, namespace: str, cr_name: str):
    ...
    def _get_s3_config(self) -> Optional[Dict[str, str]]:
        ...
        try:
            ...
            result = run_oc_command([
                "get", "secret", f"{self.cr_name}-s3-credentials",
                "-n", self.namespace,
            ...
            result = run_oc_command([
                "get", "configmap", f"{self.cr_name}-aws-config",
                "-n", self.namespace,
    ...
    def cleanup(self, rh_identity_header: str):
        ...
        koku_api_url = build_koku_api_url(self.cr_name, self.namespace)

...
def rbac_cluster_data(
    ...
    koku_url = get_koku_api_url(cluster_config.cr_name, cluster_config.namespace)
...
def rbac_access_setup(
    ...
    valkey_pod = get_pod_by_label(cluster_config.namespace, "app.kubernetes.io/component=cache")

...
#
# PREREQUISITE: Run this BEFORE applying CostManagementServiceConfig / deploy-test.sh
#
# Typical workflow:
#   1. ./scripts/deploy-kafka.sh   # Deploy Kafka infrastructure (this script)
#   2. ./scripts/install-cmsc.sh    # Deploy operator workload (CMSC)
#
...
display_summary() {
    ...
    echo_info "  2. Deploy Cost Management On-Premise application: ./scripts/install-cmsc.sh"
    echo ""
}

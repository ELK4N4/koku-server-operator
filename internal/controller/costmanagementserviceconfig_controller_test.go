...
var _ = Describe("CostManagementServiceConfig Controller", func() {
	Context("When reconciling a resource", func() {
		...
		costmanagementserviceconfig := &costmanagementservicecfgv1alpha1.CostManagementServiceConfig{}
		...
		BeforeEach(func() {
			...
			if err != nil && errors.IsNotFound(err) {
				resource := &costmanagementservicecfgv1alpha1.CostManagementServiceConfig{
